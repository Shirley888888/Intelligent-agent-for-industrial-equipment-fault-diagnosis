...
## V8 Agent model unification
<!-- modify:model-unification -->
The current Agent/training configuration is unified to LSTM only. Older multi-model comparison text above describes historical experiment-readiness work and is not part of the current Agent deployment path.
